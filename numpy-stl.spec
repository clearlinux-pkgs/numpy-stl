...
Source0  : https://files.pythonhosted.org/packages/d0/48/1404981caf68e517ea51d2efbd9b17002367748090ab2f6d6e17d21a15ad/numpy-stl-3.1.1.tar.gz
...
%prep
%setup -q -n numpy-stl-3.1.1
cd %{_builddir}/numpy-stl-3.1.1
pushd ..
cp -a numpy-stl-3.1.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1704468385
