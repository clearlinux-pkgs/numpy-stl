...
Version  : 2.14.2
Release  : 19
URL      : https://github.com/WoLpH/numpy-stl/releases/download/v2.14.2/numpy-stl-v2.14.2.tar.xz
Source0  : https://github.com/WoLpH/numpy-stl/releases/download/v2.14.2/numpy-stl-v2.14.2.tar.xz
Source1  : https://github.com/WoLpH/numpy-stl/releases/download/v2.14.2/numpy-stl-v2.14.2.tar.xz.asc
...
%prep
%setup -q -n numpy-stl-v2.14.2
cd %{_builddir}/numpy-stl-v2.14.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1612199152
...
cp %{_builddir}/numpy-stl-v2.14.2/LICENSE %{buildroot}/usr/share/package-licenses/numpy-stl/7f2ba3d85548b142cdd896317a0a190793940c1f
cp %{_builddir}/numpy-stl-v2.14.2/docs/_theme/LICENSE %{buildroot}/usr/share/package-licenses/numpy-stl/3d1c6f6ce9ac9fdbae7bdc2b4d63940561f79edd
