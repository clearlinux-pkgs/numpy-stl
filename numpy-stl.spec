...
%prep
%setup -q -n numpy-stl-v2.16.3
cd %{_builddir}/numpy-stl-v2.16.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1642360491
...
cp %{_builddir}/numpy-stl-v2.16.3/LICENSE %{buildroot}/usr/share/package-licenses/numpy-stl/7f2ba3d85548b142cdd896317a0a190793940c1f
cp %{_builddir}/numpy-stl-v2.16.3/docs/_theme/LICENSE %{buildroot}/usr/share/package-licenses/numpy-stl/3d1c6f6ce9ac9fdbae7bdc2b4d63940561f79edd
