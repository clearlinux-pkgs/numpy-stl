...
Version  : 2.12.0
Release  : 13
URL      : https://github.com/WoLpH/numpy-stl/releases/download/v2.12.0/numpy-stl-v2.12.0.tar.xz
Source0  : https://github.com/WoLpH/numpy-stl/releases/download/v2.12.0/numpy-stl-v2.12.0.tar.xz
Source1  : https://github.com/WoLpH/numpy-stl/releases/download/v2.12.0/numpy-stl-v2.12.0.tar.xz.asc
...
%prep
%setup -q -n numpy-stl-v2.12.0
cd %{_builddir}/numpy-stl-v2.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1603119390
...
cp %{_builddir}/numpy-stl-v2.12.0/LICENSE %{buildroot}/usr/share/package-licenses/numpy-stl/7f2ba3d85548b142cdd896317a0a190793940c1f
cp %{_builddir}/numpy-stl-v2.12.0/docs/_theme/LICENSE %{buildroot}/usr/share/package-licenses/numpy-stl/3d1c6f6ce9ac9fdbae7bdc2b4d63940561f79edd
